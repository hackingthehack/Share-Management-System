...
export default function Login() {
  ...
  return (
    <Heator>
      <div className="flex justify-center  h-screen  xl:justify-around gap-2  " style={{ backgroundColor: '#49696c' }}>
        
        <div className="mt-16 w-1/2 h-3/5  p-8 rounded-3xl" style={{ backgroundColor: '#FFFFFF' }}>
          <div>
          ...
          <div>
            ...
            >
              ...
              <div className="mb-2 mt-6">
                <button
                  type="submit"
                  className="w-full py-2 px-4 bg-blue-500 text-white rounded-md hover:bg-blue-600 focus:outline-none focus:ring focus:border-blue-300 mb-5"
                >
                  log in
                </button>
              </div>
