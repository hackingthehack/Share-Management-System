...
const SideBar = forwardRef(({ showNav }, ref) => {
  ...
  return (
   ...
   <div className="">
    <div ref={ref} className="object-cover fixed w-56 bg-stone-700 shadow-sm scroll-mb-20 top-0 left-0 bottom-0 max-h-screen mt-14 overflow-y-auto ">
      ...
      <div className="flex flex-col ">
        ...
        <Link href="/admin1/newBuyersList">
          <div
           className={`pl-6 py-3 mx-5 rounded text-center cursor-pointer mb-3 flex items-center transition-colors ${
            router.pathname == "/admin1/newBuyersList"
              ? "bg-orange-100 text-gray-900"
              : "text-gray-300 hover:bg-orange-100 hover:text-gray-900"
          }`}
          >
        ...
        >
          <div className="mr-2">
            <RiArrowUpDownFill className="h-5 w-5" />
          </div>
          <div>
            <p>ShareAdd </p>
          </div>
